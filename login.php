    ...
    <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="row mb-3">
            ...
            <div class="col-6 text-right">
              <a class="float-right" href="php_reset_password.php">Forgot Password?</a>
            </div>
        </div>
        <div class="form-group mb-3">
            <button type="submit" class="btn btn-primary login-btn btn-block" onclick="myFunction()">Signin</button>
        </div>
